...
def align_matrices(coor_list, bcr_header, bcr_array, rots_count, pi_mult):
	pdb_matrices, list_of_all_rots, list_of_axisangles = pdb_rots_to_bins(coor_list, bcr_header, rots_count, pi_mult)	
	...
	return(list_of_axisangles, korel_sums, matrices_of_diffs, aligned_matrices)
