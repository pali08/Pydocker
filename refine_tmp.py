...
class Refine(object)
    ...
    def __init__(self, angle_refin, points_count_refin, res_num_to_refine, best_fit, pdb, bcr, docker_rough_output):
    ...
    def rotate(self,self.docker_rough_output, self.res_num_to_refine, self.pdb_list):
    ...
    def compare_and_output(self)
         compare_and_output(infilename_pdb, infilename_bcr, rots_count, rots_count_around_z, best_fits_count,project_name): 
